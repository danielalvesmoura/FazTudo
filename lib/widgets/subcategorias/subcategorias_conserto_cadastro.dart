...
class SubcategoriasConsertoCadastro extends StatefulWidget {
  @override
...
enum SubcategoriasConsertoEnum { eletrico, encanamento, mecanico, alvenaria, eletronico}

class SubcategoriasState extends State<SubcategoriasConsertoCadastro> {
  SubcategoriasConsertoEnum selecionado = SubcategoriasConsertoEnum.eletrico;
